...
<div style="height:100%"  @click="hide">
 ...
 <div  class="audio_room" v-show="aduio_show" @mousedown.self="video_move"> 
    ...
    <!-- 接听视频 -->
            <!-- <el-dialog
        title="提示"
        :visible.sync="calling_Visible"
        width="30%"
        >
        <span>这是一段信息</span>
        <span slot="footer" class="dialog-footer">
            <el-button @click="calling_Visible = false">取 消</el-button>
            <el-button type="primary" @click="call_answer">确 定</el-button>
        </span>
        </el-dialog> -->
